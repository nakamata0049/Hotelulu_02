...
public class UserController {
	...
	@GetMapping
	public String index(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) { //ログイン時のユーザー情報をメソッドの引数で受け取る
		User user = userRepository.getReferenceById(userDetailsImpl.getUser().getId()); //最新のユーザー情報を受け取る
